...
1) R_{total}=1.6*10^6 and \eta=0.02,0.04,0.08 can generate data for Figure S2A.
   We name these files: deltaT_eta_0_02.dat, deltaT_eta_0_04.dat, and deltaT_eta_0_08.dat
1) R_{total}=10^5,10^6,10^7,10^8 and \eta=0.04 can generate data for Figure S2B.
   We name these files: deltaT_R_5.dat, deltaT_R_6.dat, deltaT_R_7.dat, and deltaT_R_8.dat
3) R_{total}=1.6*10^6 and \eta=0.04 can generate data for Figure S3.
